...
% Last Modified by GUIDE v2.5 12-Jun-2019 01:01:49
...
% --- Executes on selection change in Instrucciones.
function Instrucciones_Callback(hObject, eventdata, handles)
% hObject    handle to Instrucciones (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns Instrucciones contents as cell array
%        contents{get(hObject,'Value')} returns selected item from Instrucciones


% --- Executes during object creation, after setting all properties.
function Instrucciones_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Instrucciones (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
% --- Executes on button press in VolverBttn.
function VolverBttn_Callback(hObject, eventdata, handles)
% hObject    handle to VolverBttn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
clc;
close;
